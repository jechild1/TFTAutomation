...
/**
 * Page factory for the Delete Team Page in the Team Fitness Tracker
 * application.<br>
 * 
 ...
 */
public class DeleteTeamPageFactory extends TestConfig {
	
	/**
	 * Page Constructor: Accepts the WebDriver from the calling page &
	 * instantiates the elements on the page.
	 */
	public DeleteTeamPageFactory() {
	...
	/**
	 * Returns a reference to the team name label. 
	 */
	...
	/**
	 * Reads the value of the Team Name field.
	 * @return String
	 */
	public String readTeamName(){
		Reporter.log("Starting Team Name read", true);
		String myText = teamName.getText();
		Reporter.log("Team name value is: " + myText, true);
		Reporter.log("", true);
