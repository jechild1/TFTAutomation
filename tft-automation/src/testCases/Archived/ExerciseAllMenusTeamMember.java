 ...
 * Member role, only asserting that the page loads and the title is correct.
 * 
 * @author jesse.childress
 *
 */
public class ExerciseAllMenusTeamMember extends TFTConfig {
	...
	@DataProvider(name = "teamMemberAccount")
	private String[][] getUserAccount() {
		return new String[][]{{TEAM_MEMBER_USERNAME, TEAM_MEMBER_PASSWORD}};
	}

	@Test(dataProvider = "teamMemberAccount")
	...
	public void exerciseMyMenuTeamMember() {
	...
	public void exerciseReportsTeamMember() {
		AutomationHelper.printClassName();
		AutomationHelper.printMethodName();
